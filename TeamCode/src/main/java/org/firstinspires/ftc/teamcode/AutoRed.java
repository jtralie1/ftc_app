    ...
    public void runOpMode() {
       ...
       /* for (int i = 0; i < 12000; i++)
        ...
        for (int i = 0; i <35000; i++) {
            brake(0);
            shooterLeft.setPower(.8);
            shooterRight.setPower(-.8);
            if (i > 12000)
                lift.setPosition(.15);
        ...
        //This goes backward an absurd amount. No idea why.
       ...
       /* if (true) {
        ...
        if (wallCS.red() > 2 && wallCS.blue()<2) {
            ...
            for (int j = 0; j<10;j++){
                ...
                for (int i = 0; i <8000; i++)
                    brake(0);
                if (wallCS.red() > 2 && wallCS.blue()<2 && button1 == false) {
                    for (int i = 0; i < 30000; i++) {
                        strafeRight();
                    }
                    for (int i = 0; i < 30000; i++) {
